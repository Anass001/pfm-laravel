        ...
        <div class="container justify-content-center d-flex flex-column pt-5">
            ...
            @foreach($results as $result)
                <div class="card flex-row mb-5" style="width: 100%; height: 250px">
                    <div class="h-100"
                         style="background-image: url('https://t-cf.bstatic.com/xdata/images/hotel/square200/60843791.webp?k=f73b84de682171bc8703508751c88d45ffba55ca174838fde2e4cc8465ff7333&o=&s=1');
